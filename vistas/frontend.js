    ...
    if(!localStorage.estaLogeado){
        ...
        $scope.imprimirRecibos = function(){
            ...
            if(liquidacionesImprimir.length > 0){
                ...
                $http.post("/liquidaciones/imprimir", $scope.imprimir, {responseType: "blob"}).then(respuestaOk, respuestaError);

                function respuestaOk(respuesta){
                    //console.log(respuesta.data);
                    var file = new Blob([respuesta.data], {type: "application/pdf"});
...
appEmpresa.controller("controladorEmpresaLiquidacionNueva", function($scope, $http, $location){
    ...
    if(!localStorage.estaLogeado){
        ...
        function updateHaberes(){
            ...
            $scope.empleadoSeleccionado.haberes = 0;
            if(typeof $scope.empleadoSeleccionado.descuentoFaltas === "undefined" || $scope.empleadoSeleccionado.descuentoFaltas == null || !$scope.liquidacion.tieneFaltas || $scope.empleadoSeleccionado.descuentoFaltas == ""){
                $scope.empleadoSeleccionado.descuentoFaltas = 0;
            }
            if(typeof $scope.empleadoSeleccionado.montoHorasExtra === "undefined" || $scope.empleadoSeleccionado.montoHorasExtra == null || !$scope.liquidacion.tieneHorasExtra || $scope.empleadoSeleccionado.montoHorasExtra == ""){
                $scope.empleadoSeleccionado.montoHorasExtra = 0;
            }
            if(typeof $scope.liquidacion.fictoPropina === "undefined" || $scope.liquidacion.fictoPropina == null || !$scope.liquidacion.tieneFictoPropina || $scope.liquidacion.fictoPropina == ""){
                $scope.liquidacion.fictoPropina = 0;
            }
            if(typeof $scope.liquidacion.montoDescansoTrabajado === "undefined" || $scope.liquidacion.montoDescansoTrabajado == null || !$scope.liquidacion.tieneDescansoTrabajado || $scope.liquidacion.montoDescansoTrabajado == ""){
                $scope.liquidacion.montoDescansoTrabajado = 0;
            }
            if(typeof $scope.liquidacion.montoFeriadoPago === "undefined" || $scope.liquidacion.montoFeriadoPago == null || !$scope.liquidacion.tieneFeriadoPago || $scope.liquidacion.montoFeriadoPago == ""){
                $scope.liquidacion.montoFeriadoPago = 0;
            }
            if(typeof $scope.liquidacion.primaPorAntiguedad === "undefined" || $scope.liquidacion.primaPorAntiguedad == null || !$scope.liquidacion.tienePrimaPorAntiguedad || $scope.liquidacion.primaPorAntiguedad == ""){
                $scope.liquidacion.primaPorAntiguedad = 0;
            }
            if(typeof $scope.liquidacion.primaPorProductividad === "undefined" || $scope.liquidacion.primaPorProductividad == null || !$scope.liquidacion.tienePrimaPorProductividad || $scope.liquidacion.primaPorProductividad == ""){
                $scope.liquidacion.primaPorProductividad = 0;
            }
            if(typeof $scope.liquidacion.adelanto === "undefined" || $scope.liquidacion.adelanto == null || !$scope.liquidacion.tieneAdelanto || $scope.liquidacion.adelanto == ""){
                $scope.liquidacion.adelanto = 0;
            }
            if(typeof $scope.liquidacion.retencion === "undefined" || $scope.liquidacion.retencion == null || !$scope.liquidacion.tieneRetencion || $scope.liquidacion.retencion == ""){
            ...
            console.log("Ficto Propina: " + $scope.liquidacion.fictoPropina);
            console.log("Prima por Antigüedad: " + $scope.liquidacion.primaPorAntiguedad);
